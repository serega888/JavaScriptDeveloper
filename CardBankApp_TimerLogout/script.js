...
const account4 = {
  userName: 'Sergey Red',
  transactions: [5300, 13000, 5000, 400, 1900, 700, -200],
  interest: 1,
  pin: 44444,
  transactionsDates: [
...
const account5 = {
  ...
  transactions: [6300, 8000, 3000, 500, 1200, 800, 200],
  interest: 1.1,
  pin: 55555,
  transactionsDates: [
    '2022-04-02T15:43:31.074Z',
...
const formatCurrency = function (valueTrans, locale, currency) {
...
const displayTransactions = function (account, sort = false) {
  ...
  transactionsSorted.forEach(function (trans, index) {
    ...
    const transCurrency = formatCurrency(
      trans,
      account.locale,
      account.currency
    );
    ...
    <div class="transactions__row">
      ...
      <div class="transactions__value">${transCurrency}</div>
    </div>`;
...
const displayBalance = function (account) {
  ...
  // console.log(typeof account.balance, account.balance);
};
...
const displayTotal = function (account) {
  ...
  // console.log(typeof depositTotal, depositTotal);
  ...
  // console.log(typeof withdrawalTotal, withdrawalTotal);
...
['mouseover', 'click', 'keyup'].forEach(function (i) {
